...
const NAV_ITEMS = [
  { path: '/safety-law', ko: '산업안전보건법', en: 'Safety Law' },
  { path: '/safety-management', ko: '안전관리', en: 'Safety' },
  { path: '/health-management', ko: '보건관리', en: 'Health' },
  { path: '/risk-assessment', ko: '위험성평가', en: 'Risk' },
  { path: '/accident-prevention', ko: '재해 예방', en: 'Prevention' },
  { path: '/safety-education', ko: '안전교육', en: 'Education' },
  { path: '/work-environment', ko: '작업환경', en: 'Environment' },
  { path: '/emergency-response', ko: '비상대응', en: 'Emergency' },
];
      ...
      <nav className={`navbar ${isScrolled ? 'scrolled' : ''}`}>
        <div className="navbar-inner">
          <Link to="/" className="navbar-logo">
            <span className="logo-study">Safety</span>
            <span className="logo-master">Guard</span>
          </Link>
